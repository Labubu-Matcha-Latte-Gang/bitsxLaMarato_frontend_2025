...
class ApiService {
  ...
  // Patient search and management for doctors
  static Future<PatientSearchResult> searchPatientsForDoctor(
    String query, {
    int limit = 20,
  }) async {
  ...
  static Future<UserProfile> _mutateDoctorPatients({
    ...
    if (patients.isEmpty) {
      throw ApiException('La llista de pacients està buida.', 400);
    }
  ...
  static Future<List<int>> downloadPatientReport(
    String email, {
    String timezone = 'Europe/Madrid',
  }) async {
    try {
  ...
  static Future<void> _persistUserProfile(
    ...
    if (alreadyRespondedToday != null) {
      userData['already_responded_today'] = alreadyRespondedToday;
    }
