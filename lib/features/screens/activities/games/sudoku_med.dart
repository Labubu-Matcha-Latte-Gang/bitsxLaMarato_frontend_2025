...
class SudokuMedPage extends StatefulWidget {
  final bool isDarkMode;
  final String? activityId;
  const SudokuMedPage({Key? key, this.isDarkMode = false, this.activityId}) : super(key: key);

  @override
  State<SudokuMedPage> createState() => _SudokuMedPageState();
}

class _SudokuMedPageState extends State<SudokuMedPage> {
