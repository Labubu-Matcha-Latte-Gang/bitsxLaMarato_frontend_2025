...
class WordleEasyScreen extends StatefulWidget {
  final bool isDarkMode;
  // Optional explicit activity id (preferred), and name fallback
  final String? activityId;

  const WordleEasyScreen({Key? key, this.isDarkMode = true, this.activityId}) : super(key: key);

  @override
  State<WordleEasyScreen> createState() => _WordleEasyScreenState();
}

enum LetterState { initial, correct, present, absent }

class _WordleEasyScreenState extends State<WordleEasyScreen>
