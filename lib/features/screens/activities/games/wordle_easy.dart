...
// Wordle game screen: 6 tries, 5-letter words.
...
class _WordleScreenState extends State<WordleScreen>
    ...
    try {
      ...
      try {
        ...
        if (decoded.startsWith('[')) {
          final List<dynamic> arr = (jsonDecode(decoded)) as List<dynamic>;
  ...
  void _showEndDialog({required bool won}) {
    ...
    showDialog<void>(
      ...
      builder: (ctx) {
        return AlertDialog(
          title: Text(won ? 'Has guanyat!' : 'Final'),
          content: Column(
            ...
            children: [
              ...
              Text('Intent(s):', style: const TextStyle(fontWeight: FontWeight.bold)),
            ...
            TextButton(
              onPressed: () {
                Navigator.of(ctx).pushReplacement(
                  MaterialPageRoute(
                    builder: (_) => RecommendedActivitiesPage(initialDarkMode: isDark),
                  ),
                );
              },
